<?php
	...
	$cst = TableRegistry::get('Customers')->find()->where(['id' => $this->getRequest()->getQuery('id')])->first();
?>
...
<?php if ($cst): ?>
	<div class="breadcrumb_div">
		<ol class="breadcrumb m-b-20">
			...
			<li class="breadcrumb-item active">新規定期便登録</li>
		</ol>
	</div>
<?php else: ?>
	<div class="breadcrumb_div">
...
<div class="priceTables form large-9 medium-8 columns content">
	...
	<fieldset>
		<div class="text-center">
			<legend><?= isset($cst) ? $cst->customers_name . __('様 新規定期便登録') : __('新規定期便登録') ?></legend>
			<p class="form-paragraph">
				※定期便の基本情報を登録ください。紐づく経路情報は基本情報登録後に実施ください。
			</p>
		</div>
