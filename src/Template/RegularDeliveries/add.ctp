...
<div class="breadcrumb_div">
	<ol class="breadcrumb m-b-20">
		...
		<li class="breadcrumb-item active">新規定期便経路登録</li>
	</ol>
</div>
	...
	<fieldset>
		...
		<?php
			...
			echo $this->Form->control('deliveries_or_cargo', array(
					...
					'value' => $this->request->getData('deliveries_or_cargo'),
					'class' => 'form-control'      // inputタグのクラス名
			));
			echo $this->Form->control('outward_or_return', array(
					...
					'value' => $this->request->getData('outward_or_return'),
					'class' => 'form-control'      // inputタグのクラス名
			));
			...
			echo $this->Form->control('start_location', array(
					...
					'value' => $this->request->getData('start_location'),
					'id' => 'start_location',
					'class' => 'form-control select2'      // inputタグのクラス名
			));
			echo $this->Form->control('destination', array(
					...
					'value' => $this->request->getData('destination'),
					'id' => 'destination',
					'class' => 'form-control select2'      // inputタグのクラス名
			));
