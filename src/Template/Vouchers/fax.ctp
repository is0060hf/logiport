<?php
	 ...
	 * @var \App\Model\Entity\Voucher[]|\Cake\Collection\CollectionInterface $vouchersExcludeDestination
	 */
...
<div class="row">
	<div class="col-6 breadcrumb_div">
		<ol class="breadcrumb m-b-20">
			...
			<li class="breadcrumb-item active">FAX送付状生成</li>
		</ol>
	</div>
</div>
				...
				<div class="card-body">
					...
					<div class="row my-2">
						<div class="col-12 text-center">
							<button class="btn btn-success mr-3" type="submit" name="submit_btn" value="fax_hakkou">
								<i class="fe-edit"></i>
								<span>FAX送付状を生成する</span>
							</button>
						</div>
					</div>
				</div>
