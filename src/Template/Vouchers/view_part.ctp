	...
	<div class="row mb-4">
		...
		<div class="col-sm-4 offset-sm-2">
			<div class="mt-3 float-right">
				...
				<p class="m-b-10"><strong>発行歴 : </strong> <span class="float-right"><span class="badge badge-danger">Unpaid</span></span>
				</p>
							...
							<div class="card-body">
								...
								<table class="table">
									...
									<?php foreach ($voucher->deliveries as $delivery) : ?>
										<tr>
											<td>
												<a href="<?php echo $this->Url->build(['controller' => 'Deliveries', 'action' => 'view', $delivery->id]); ?>">
													<?= h($delivery->id); ?>
												</a>
											</td>
								...
								<?php
									...
									echo $this->Form->control('additional_price', array(
											...
											'templateVars' => array(
													...
													'div_tooltip' => 'tooltip',
													'div_tooltip_placement' => 'top',
													'div_tooltip_title' => '高速代や、追加作業、待ち時間などの追加料金を入力してください。'
											),
											'class' => 'form-control'      // inputタグのクラス名
									));
									echo $this->Form->control('advances_paid', array(
											...
											'templateVars' => array(
													...
													'div_tooltip' => 'tooltip',
													'div_tooltip_placement' => 'top',
													'div_tooltip_title' => '立替金を入力してください。高速代なども、立替の場合はこちらに入力してください。'
											),
											'class' => 'form-control'      // inputタグのクラス名
									));
